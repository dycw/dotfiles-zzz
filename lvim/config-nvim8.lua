...
lvim.builtin.which_key.mappings = {
  ...
  ["g"] = {
    ...
    ["k"] = { ":lua require('gitsigns').prev_hunk({navigation_message = false})<CR>", "Previous hunk" },
  ...
  ["r"] = { ":lua require('spectre').open_file_search()<CR>", "Spectre file" },
  ["R"] = { ":lua require('spectre').open()<CR>", "Spectre" },
