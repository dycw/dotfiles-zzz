...
if GUI_AVAILABLE:
    ...
    def download():
        ...
        class DownloadDialog(Gtk.Dialog):
            ...
            def __init__(self):
                super().__init__(parent=None, title="Dropbox Installation")
                ...
                self.label.set_markup(
                    f'{INFO} <span foreground="#000099" underline="single" weight="bold">{LINK}</span>\n\n{WARNING}{GPG_WARNING_MSG}'
                )
            ...
            if options.list:
                ...
                def path_to_string(file_path):
                    ...
                    try:
                        ...
                        path = f"{os.path.basename(file_path)} ({e})"
                        return path, path
...
def throttle(args):
    ...
    kwargs = {"download_mode": download_mode, "upload_mode": upload_mode}
    if download_limit:
